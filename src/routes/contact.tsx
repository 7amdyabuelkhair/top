...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Request a quote for ferro alloys, carburisers, virgin metals, minerals, ores or refractories.",
      },
      { property: "og:title", content: "Contact — Top Trust Metal Products" },
      {
